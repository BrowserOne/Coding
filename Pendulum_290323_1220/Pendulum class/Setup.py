...
class pendulum:
        ...
        Arguments:
            ...
            setstep: Integration method used in calculation of motion.
                     Valid options include:
                        ...
                        -Runge-kuttaSimple
                        -Runge-KuttaDouble
                    Where the simple methods is for the simple pendulum and the double is for the double pendulum methods.
        """
        self._L = L                 #[m]
        self._M = M                 #[Kg]
        self._t = t                 #[s]
    ...
    def valid(self):
        """
        Function used to validate the motion calculated by the step function.
        If the Left Hand Side (lhs) and Right Hand Side (rhs) of both the equations don't match, function puts out an error count)

        Arguments:
        ----------
            self: object containing all the attributes of the pendulum

        Returns:
        --------
            0 if properties of calculated motion match with the equations of motion
            1 if the properties do not match the equations of motion
