...
#print initial final and difference in energy
print("final energy:{:.4f} - initial energy:{:.4f}=".format( energy[-1],energy[0] ))
print("{:.4f}".format(energy[-1] - energy[0]))
...
while i/f <= position[-1]:
    ...
    #select wether animation is of simple pendulum or double pendulum
    plot_double()
