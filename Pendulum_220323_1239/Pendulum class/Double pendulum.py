...
ob = pd(np.array([1.0,1.0]), np.array([10,1]),theta = np.array([170,90]), omega = np.array([0.0,0.0]), setstep = 'Runge-KuttaDouble')
...
print("Calculation completed in {:0.1f}s".format(time.time() - start_time))
