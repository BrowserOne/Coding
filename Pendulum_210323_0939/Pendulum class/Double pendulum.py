...
It uses the pendulum class in the Setup file to define two pendulum objects and uses the setup function from the pendulum class to iterate the motion of the pendulum.
...
#setup variable for two objects in the format of a list (lenght, mass, starting angle, starting angular velocity and differentiation method used for iteration)
